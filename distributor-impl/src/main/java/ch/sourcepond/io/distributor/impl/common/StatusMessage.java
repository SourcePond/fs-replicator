 ...
 */
public class StatusMessage extends DistributionMessage {
     ...
     * @param pPath
     */
    public StatusMessage(final String pPath) {
        this(pPath, null);
    }

    public StatusMessage(final String pPath, final IOException pFailureOrNull) {
        super(pPath);
