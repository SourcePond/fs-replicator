 ...
 */
public class StatusResponse extends DistributionMessage {
     ...
     * @param pPath
     */
    public StatusResponse(final String pPath) {
        this(pPath, null);
    }

    public StatusResponse(final String pPath, final IOException pFailureOrNull) {
        super(pPath);
