...
import ch.sourcepond.io.fssync.distributor.impl.lock.LockManager;
import ch.sourcepond.io.fssync.distributor.impl.request.RequestDistributor;
...
final class HazelcastDistributor implements Distributor {
    ...
    @Override
    public void discard(final String pPath, final IOException pFailure) throws DiscardException {
        requestDistributor.discard(requireNonNull(pPath, "path is null"), requireNonNull(pFailure, "failure is null"));
    }

    @Override
    public void store(final String pPath, final byte[] pChecksum) throws StoreException {
